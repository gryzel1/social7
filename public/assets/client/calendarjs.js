...
function calendarJs( id, options, searchOptions, startDateTime ) {
    ...
    function setTranslationStringOptions() {
        ...
        if ( !isDefinedString( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Ajouter événement";
        }
        ...
        if ( !isDefinedString( _options.refreshTooltipText ) ) {
            _options.refreshTooltipText = "Rafraîchir";
        }

        if ( !isDefinedString( _options.searchTooltipText ) ) {
            _options.searchTooltipText = "Rechercher";
        }

        if ( !isDefinedString( _options.expandDayTooltipText ) ) {
            _options.expandDayTooltipText = "Etendre la journée";
        }

        if ( !isDefinedString( _options.listAllEventsTooltipText ) ) {
            _options.listAllEventsTooltipText = "Vue de tous les événements";
        }

        if ( !isDefinedString( _options.listWeekEventsTooltipText ) ) {
            _options.listWeekEventsTooltipText = "Vue des événements de cette semaine";
        }
        ...
        if ( !isDefinedString( _options.isAllDayText ) ) {
            _options.isAllDayText = "est toute la journée";
        }
        ...
        if ( !isDefinedString( _options.removeEventText ) ) {
            _options.removeEventText = "Effacer";
        }

        if ( !isDefinedString( _options.addEventTitle ) ) {
            _options.addEventTitle = "Ajouter événement";
        }

        if ( !isDefinedString( _options.editEventTitle ) ) {
            _options.editEventTitle = "Modifier événement";
        }

        if ( !isDefinedString( _options.exportStartFilename ) ) {
            _options.exportStartFilename = "evenement-export";
        }

        if ( !isDefinedString( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Merci de choisir un temps 'de' valide";
        }

        if ( !isDefinedString( _options.toTimeErrorMessage ) ) {
            _options.toTimeErrorMessage = "Merci de choisir un temps 'à' valide";
        }

        if ( !isDefinedString( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Merci de choisir une date 'à' plus grande que la date 'de'";
        }

        if ( !isDefinedString( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "Merci d'entrer une valeur dans le champ 'titre' (pas d'espace vide)";
        }
        ...
        if ( !isDefinedString( _options.allDayText ) ) {
            _options.allDayText = "Jour complet";
        }
        ...
        if ( !isDefinedString( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirmer l'effacement de l'événement";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventsRemoveMessage = "Effacer cet événement est définif. êtes vous sur de continuer?";
        }
        ...
        if ( !isDefinedString( _options.selectExportTypeTitle ) ) {
            _options.selectExportTypeTitle = "Choix tu type d'export";
        }
        
        if ( !isDefinedString( _options.selectColorsText ) ) {
            _options.selectColorsText = "Choix des couleurs";
        }
        
        if ( !isDefinedString( _options.backgroundColorText ) ) {
            _options.backgroundColorText = "Couleur du fond:";
        }
        ...
        if ( !isDefinedString( _options.borderColorText ) ) {
            _options.borderColorText = "Couleur des bords:";
        }
        
        if ( !isDefinedString( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "rechercher événements";
        }
        ...
        if ( !isDefinedString( _options.expandMonthTooltipText ) ) {
            _options.expandMonthTooltipText = "Etendre au mois";
        }
        
        if ( !isDefinedString( _options.repeatEndsText ) ) {
            _options.repeatEndsText = "RRépéter les fins:";
        }
        
        if ( !isDefinedString( _options.noEventsAvailableText ) ) {
            _options.noEventsAvailableText = "Pas d'événements disponibles.";
        }
        
        if ( !isDefinedString( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "Vue des événements de la Semaine";
        }
        
        if ( !isDefinedString( _options.noEventsAvailableFullText ) ) {
            _options.noEventsAvailableFullText = "Aucun événement.";
        }
        
        if ( !isDefinedString( _options.clickText ) ) {
            _options.clickText = "Clicker";
        }
        
        if ( !isDefinedString( _options.hereText ) ) {
            _options.hereText = "là";
        }
        
        if ( !isDefinedString( _options.toAddANewEventText ) ) {
            _options.toAddANewEventText = "pour ajouter un nouvel événement.";
        }
        
        if ( !isDefinedString( _options.weekText ) ) {
            _options.weekText = "Semaine";
        }
        
        if ( !isDefinedString( _options.groupText ) ) {
            _options.groupText = "Groupe:";
        }
        ...
        if ( !isDefinedString( _options.groupsTabText ) ) {
            _options.groupsTabText = "Groupes";
        }
        ...
        if ( !isDefinedString( _options.eventNotificationBody ) ) {
            _options.eventNotificationBody = "L'événement '{0}' a commencé.";
        }
        ...
        if ( !isDefinedString( _options.endsWithText ) ) {
            _options.endsWithText = "Fini avec";
        }
        ...
        if ( !isDefinedString( _options.displayTabText ) ) {
            _options.displayTabText = "Montrer";
        }
        
        if ( !isDefinedString( _options.enableAutoRefreshForEventsText ) ) {
            _options.enableAutoRefreshForEventsText = "Activer  l'auto-refresh pour les événements";
        }

        if ( !isDefinedString( _options.enableBrowserNotificationsText ) ) {
            _options.enableBrowserNotificationsText = "Activer les notifications du navigateur";
        }

        if ( !isDefinedString( _options.enableTooltipsText ) ) {
            _options.enableTooltipsText = "Activer tooltips";
        }

        if ( !isDefinedString( _options.dayText ) ) {
            _options.dayText = "jour";
        }

        if ( !isDefinedString( _options.daysText ) ) {
            _options.daysText = "jours";
        }

        if ( !isDefinedString( _options.hourText ) ) {
            _options.hourText = "heure";
        }

        if ( !isDefinedString( _options.hoursText ) ) {
            _options.hoursText = "heures";
        }
        ...
        if ( !isDefinedString( _options.enableDragAndDropForEventText ) ) {
            _options.enableDragAndDropForEventText = "Activer drag & drop pour les événements";
        }

        if ( !isDefinedString( _options.organizerTabText ) ) {
            _options.organizerTabText = "Organiseur";
        }

        if ( !isDefinedString( _options.removeEventsTooltipText ) ) {
            _options.removeEventsTooltipText = "Effacer Evénement";
        }

        if ( !isDefinedString( _options.confirmEventsRemoveTitle ) ) {
            _options.confirmEventsRemoveTitle = "Confirmer l'effacement de l'événement";
        }
        
        if ( !isDefinedString( _options.confirmEventsRemoveMessage ) ) {
            _options.confirmEventsRemoveMessage = "Effacer ces événements non répétés est définif. ëtes vous sur de continuer?";
        }

        if ( !isDefinedString( _options.eventText ) ) {
            _options.eventText = "Evénement";
        }

        if ( !isDefinedString( _options.optionalText ) ) {
            _options.optionalText = "Optionnel";
        }
        ...
        if ( !isDefinedString( _options.openUrlText ) ) {
            _options.openUrlText = "Ouvrir Url";
        }

        if ( !isDefinedString( _options.visibleDaysTabText ) ) {
            _options.visibleDaysTabText = "Jours visibles";
        }

        if ( !isDefinedString( _options.enableDayNameHeadersInMainDisplayText ) ) {
            _options.enableDayNameHeadersInMainDisplayText = "Activer les noms des jours dans l'affichage";
        }

        if ( !isDefinedString( _options.thisWeekTooltipText ) ) {
            _options.thisWeekTooltipText = "Semaine actuelle";
        }

        if ( !isDefinedString( _options.dailyText ) ) {
            _options.dailyText = "par Jour";
        }

        if ( !isDefinedString( _options.weeklyText ) ) {
            _options.weeklyText = "par Semaines";
        }

        if ( !isDefinedString( _options.monthlyText ) ) {
            _options.monthlyText = "par Mois";
        }

        if ( !isDefinedString( _options.yearlyText ) ) {
            _options.yearlyText = "par Année";
        }

        if ( !isDefinedString( _options.repeatsByCustomSettingsText ) ) {
            _options.repeatsByCustomSettingsText = "Par paramètres personalisés";
        }

        if ( !isDefinedString( _options.lastUpdatedText ) ) {
            _options.lastUpdatedText = "Dernière mise à jour:";
        }

        if ( !isDefinedString( _options.advancedText ) ) {
            _options.advancedText = "Avancé";
        }

        if ( !isDefinedString( _options.copyText ) ) {
            _options.copyText = "Copier";
        }

        if ( !isDefinedString( _options.pasteText ) ) {
            _options.pasteText = "Coller";
        }

        if ( !isDefinedString( _options.duplicateText ) ) {
            _options.duplicateText = "Dupliquer";
        }

        if ( !isDefinedString( _options.showAlertsText ) ) {
            _options.showAlertsText = "Montre les notifications";
        }

        if ( !isDefinedString( _options.selectDatePlaceholderText ) ) {
            _options.selectDatePlaceholderText = "Choix de date...";
        }

        if ( !isDefinedString( _options.hideDayText ) ) {
            _options.hideDayText = "Cache jour";
        }

        if ( !isDefinedString( _options.notSearchText ) ) {
            _options.notSearchText = "Non (opposé)";
        }

        if ( !isDefinedString( _options.showEmptyDaysInWeekViewText ) ) {
            _options.showEmptyDaysInWeekViewText = "Montre les jours vide dans la vue par semaine";
        }

        if ( !isDefinedString( _options.showHolidaysInTheDisplaysText ) ) {
            _options.showHolidaysInTheDisplaysText = "Montre les vacances dans l'affichage principal et le titre";
        }
    }
    ...
    function getOptions( newOptions ) {
        if ( !isDefined( newOptions ) || typeof newOptions !== "objet" ) {
            newOptions = {};
        }
